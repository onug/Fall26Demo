...
- **Credits corrected.** Mick Currey asked in August to be credited by name and ONUG role, never with his employer; his tile now reads *WG1 co-lead · ONUG Board* with the ONUG mark, and the Fidelity mark is removed from the repository. Baird Kaake has not been asked how he wants to appear, so his tile reads *WG1* with the ONUG mark until he says. [Nick to Peter, 17 Sep]
